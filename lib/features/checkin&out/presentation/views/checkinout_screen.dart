...
/* 
                              FirebaseApi().sendNotification(
                                ...
                                body: 'New check-out!',
                                token:
                                    'c4OkEYJKRRWkAHfhO3JYgJ:APA91bFRU61fWkOzr_Ly8ZWuW3QBU26XZ0yXuhmVCAJlT5BYvbZPhIDzT788-B4tvoI4B0a5uqF8MqhAKpnvUwNg8dVk0VCtMhywUCfQnXsvx5G2zSYPzRE4V354Zil-XOsgm4rv9Zt9',
                                //Amira Gomaa
                              ); */
                              ...
                              FirebaseApi().sendNotification(
                                ...
                                body: 'New check-out!',
                                token:
                                    'dTUo5IOrS9eSUZLldndaZC:APA91bHPbxsNmmRlpFlxurDJtPSkuMETZqPUofDIjbFezT8ExAPyeLgNrKLa3_idFkbzmS0Ayw4kZqcYdEimbKNiRFzXs_Qz5Rl1nctjK1VYYGiggY6ZshtLqf18dPo24QCAjWiRbm-k',
                                //Salma Safi
                              );
 ...
 */
                              FirebaseApi().sendNotification(
                                title:
                                    '${widget.userModel.name} has checked in!',
                                body:
                                    'New check-in at ${DateFormat('hh:mm a').format(DateTime.now())}!',
                                token:
                                    'dTUo5IOrS9eSUZLldndaZC:APA91bHPbxsNmmRlpFlxurDJtPSkuMETZqPUofDIjbFezT8ExAPyeLgNrKLa3_idFkbzmS0Ayw4kZqcYdEimbKNiRFzXs_Qz5Rl1nctjK1VYYGiggY6ZshtLqf18dPo24QCAjWiRbm-k',
                                //Salma Safi
                              );
                                ...
                                MyButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (isCheckOutDone == false &&
                                        checkOutDetails != '......') {
                                      DocumentReference employeeDoc3 =
                                          FirebaseFirestore
                                              .instance
                                              .collection('Employees')
                                              .doc(widget.userModel.id)
