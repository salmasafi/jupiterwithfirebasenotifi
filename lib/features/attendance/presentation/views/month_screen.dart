...
class MonthDetailsScreen extends StatelessWidget {
  ...
  Map<String, dynamic> calculateMonthWorkTime(final List<Map<String, dynamic>> checkInOuts){
    ...
    for (var checkInOut in checkInOuts) {
      totalMonthWorkTimeAsMinutes += checkInOut['totalWorkTimeAsMinutes'];
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text(
                'Total work time this month: \n${calculateMonthWorkTime(checkInOuts)['hours']} hours, ${calculateMonthWorkTime(checkInOuts)['minutes']} minutes',
